 ...
 */
 ...
 #define Sai_3DMAIN_H_
    ...
    #define MAXSHAREELEMENT 60  //Assumint a node can share a maximum of 60 elements. This is a very conservative value.
    #define MAXFACES 4          // Maximum number of faces a Tetraheadral cell can have.    
    #define MAXNODES 4          // Maximum number of nodes a Tetraheadral cell can have. 
    #define MAXCOMPONENTS 3     // Maximum number of Vector components. 
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
    Every Node is represented P(x,y,z)
    ...
    ShareElements is an array which stores the elements which share the node. 
    The number of elements sharing the node is stored in ShareCount.
    CC2NodeDist is the distance of the node from the center of the cell. 
    u,v,w are the velocity components at the node.
 */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /*
    Every Tetrahedral Cell is represented by the connection of 4 nodes named as "a", "b", "c", "d".
    The connectivity information is stored in Connect[4]. Arranged in counterclockwise orientation
    Neighbour[4] holds the neighbouring cells. if any neighour is available it will be assigned to NEIGHUNAVAILABLE
    Normals[4][3] holds the normal vector of the faces of the cell. The order of the normals is same as that of the Connect[] array.
    ...
    Area Represents the area of the cell.																					|	|
                                                                                                                            |	|
    Neighbour[] holds the three neighbouring cells. if any neighour is available it will be assigned to NEIGHUNAVAILABLE		|	|
